...
The same batch processing recommendations for seasonal distributions apply to monthly and seasonal statistics, e.g.:

```{r cmip5_stats2, eval = FALSE}
clim_stats_ar5(type = "monthly", variable = "pr", rcp = "historical")
clim_stats_ar5(type = "seasonal", variable = "tasmax", rcp = "rcp85")
```
